...
<div class="nav"><span style="font-weight: bold;">Current version: </span>0.5.4<br>
<span style="font-weight: bold;">Released: </span>2 June 2005<br>
<br>
Quick links
<ul>
...
<p>A plug-in to allow freesteam to be used from the EMSO simulation
package has been developed; stay tuned for more of these plug-ins.</p>
...
int main(){
	try{
		...
		// Part 1
		cerr &lt;&lt; endl &lt;&lt; "Part (1) - density at 10 bar, 200&deg;C" &lt;&lt; endl;
...
<ol>
  <li>Get the package <code>freesteam-0.5.4.tar.bz2</code> from <a
 href="http://sf.net/projects/freesteam">http://sf.net/projects/freesteam</a>.</li>
  ...
  <li><code>tar jxvf freesteam-0.5.4.tar.bz2</code> and <code>cd freesteam-0.5.4</code>.</li>
...
<ul>
  <li>GCC 3.3.3 (cygwin special) (active development on this platform)</li>
  <li>GCC 3.4.3 on Fedora Core 3 on a P4 (active development on this platform)</li>
  <li>GCC 3.4.2 (mingw-special) (active development on this platform)</li>
...
<ul>
  ...
  <li>The <span style="font-weight: bold;">one-way solver</span> has some problems in certain situations. For example, solving for a desired value of specific volume along the saturation curve will give errors at low temperatures, because of the 'density anomaly'. See <a href="http://pye.dyndns.org/mantis/bug_view_page.php?bug_id=0000060">this bug</a>.</li>

  <li>The current implementation uses an IAPWS Supplementary Release correlation for the density of <span style="font-weight: bold;">saturated steam </span>when the temperature exceeds that of the region 1/region 3 boundary. This is not in keeping with the 'pure' IAPWS-IF97 Release, and gives slightly different values for specific entropy at the critical point as a result. See <a href="http://pye.dyndns.org/mantis/bug_view_page.php?bug_id=0000059">this bug</a> for more information.</li>
</ul>


<h2><a name="futuredirections"></a>5. Future directions</h2>

Any help from other developers willing to assist with the development of freesteam would be greatly appreciated. Some of the things waiting 'on the drawing board' are:

<ul>
  <li>Use of the <span style="font-weight: bold;">hook library </span>which allows the <a href="http://www.rps.eng.br/emso.html">EMSO</a> system modelling program to use the freesteam library requires a non-GPL license, which we are currently preparing.</li>

  <li>Initial work is being done on an <span style="font-weight: bold;">Excel add-in</span> version using the <a href="http://xlw.sourceforge.net/">XLW</a> wrapper classes. Currentl waiting for some build issues with XLW to be resolved.</li>
  ...
  <li>Perhaps <span style="font-weight: bold;">develop a GUI </span>version using <a href="http://www.trolltech.com/">Qt</a> or <a href="http://www.wxwindows.org/">wxWindows</a> or similar. I have no experience with these so let me know if you'd like to help there.</li>

  <li>We plan to put in place hooks that will allow freesteam to be used from within <a style="font-weight: bold;" href="http://www.python.org/">Python</a>, possibly using <a href="http://www.swig.org/">SWIG</a>. Ditto.</li>
...
steam tables program for easy demonstration/interactive testing.</li>
  ...
  <li>An add-in version for OpenOffice would be good.</li>
  ...
  <li>There have been contributions for some <span style="font-weight: bold;">r</span><span style="font-weight: bold;">everse equations in Region 3</span> - I haven't incorporated these into the source code yet though.</li>
