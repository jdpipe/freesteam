...
class ConfUnit(QtGui.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.label_unit_presion = QtGui.QLabel()
        self.label_unit_presion.setText(QtGui.QApplication.translate("SteamTables", "Presión", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_presion, 2, 1, 1, 1)
        self.conf_presion = QtGui.QComboBox()
        self.Layout.addWidget(self.conf_presion, 2, 2, 1, 1)
        self.label_unit_temperatura = QtGui.QLabel()
        self.label_unit_temperatura.setText(QtGui.QApplication.translate("SteamTables", "Temperatura", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_temperatura, 3, 1, 1, 1)
        self.conf_temperatura = QtGui.QComboBox()
        self.Layout.addWidget(self.conf_temperatura, 3, 2, 1, 1)
        self.label_unit_volumen = QtGui.QLabel()
        self.label_unit_volumen.setText(QtGui.QApplication.translate("SteamTables", "Volumen", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_volumen, 4, 1, 1, 1)
        self.conf_volumen = QtGui.QComboBox()
        self.Layout.addWidget(self.conf_volumen, 4, 2, 1, 1)
        self.label_unit_entalpia = QtGui.QLabel()
        self.label_unit_entalpia.setText(QtGui.QApplication.translate("SteamTables", "Entalpía", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_entalpia, 5, 1, 1, 1)
        self.conf_entalpia = QtGui.QComboBox()
        self.Layout.addWidget(self.conf_entalpia, 5, 2, 1, 1)
        self.label_unit_entropia = QtGui.QLabel()
        self.label_unit_entropia.setText(QtGui.QApplication.translate("SteamTables", "Entropía", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_entropia, 6, 1, 1, 1)
        self.conf_entropia= QtGui.QComboBox()
        self.Layout.addWidget(self.conf_entropia, 6, 2, 1, 1)
        self.label_unit_densidad = QtGui.QLabel()
        self.label_unit_densidad.setText(QtGui.QApplication.translate("SteamTables", "Densidad", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_densidad, 7, 1, 1, 1)
        self.conf_densidad = QtGui.QComboBox()
        self.Layout.addWidget(self.conf_densidad, 7, 2, 1, 1)
        self.label_unit_conductividad = QtGui.QLabel()
        self.label_unit_conductividad.setText(QtGui.QApplication.translate("SteamTables", "Conductividad", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_conductividad, 8, 1, 1, 1)
        self.conf_conductividad = QtGui.QComboBox()
        self.Layout.addWidget(self.conf_conductividad, 8, 2, 1, 1)
        self.label_unit_capacidad = QtGui.QLabel()
        self.label_unit_capacidad.setText(QtGui.QApplication.translate("SteamTables", "Capacidad calorífica", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_capacidad, 9, 1, 1, 1)
        self.conf_capacidad = QtGui.QComboBox()
        self.Layout.addWidget(self.conf_capacidad, 9, 2, 1, 1)
        self.label_unit_viscosidad = QtGui.QLabel()
        self.label_unit_viscosidad.setText(QtGui.QApplication.translate("SteamTables", "Viscosidad", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_viscosidad, 10, 1, 1, 1)
        self.conf_viscosidad = QtGui.QComboBox()
        self.Layout.addWidget(self.conf_viscosidad, 10, 2, 1, 1)
        self.label_unit_velocidad = QtGui.QLabel()
        self.label_unit_velocidad.setText(QtGui.QApplication.translate("SteamTables", "Velocidad", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label_unit_velocidad, 11, 1, 1, 1)
...
class Isolinea(QtGui.QDialog):
    ...
    def __init__(self, UI, unidad, magnitud, ConfSection, parent=None):
        ...
        self.Personalizar.setText(QtGui.QApplication.translate("SteamTables", "Personalizar", None, QtGui.QApplication.UnicodeUTF8))
        ...
        if magnitud:
            ...
            self.Critica.setText(QtGui.QApplication.translate("SteamTables", "Incluir linea del punto crítico", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupbox = QtGui.QGroupBox()
        self.groupbox.setTitle(QtGui.QApplication.translate("SteamTables", "Estilo de línea", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.Label.setText(QtGui.QApplication.translate("SteamTables", "Etiqueta", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.Label,11,1,1,1)
        self.unit=QtGui.QCheckBox()
        self.unit.setText(QtGui.QApplication.translate("SteamTables", "Unidades en las etiquetas", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.unit,12,1,1,3)
        self.label4=QtGui.QLabel()
        self.label4.setText(QtGui.QApplication.translate("SteamTables", "Posición", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label4,13,1,1,1)
...
class General(QtGui.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.Layout.addItem(QtGui.QSpacerItem(20,20,QtGui.QSizePolicy.Fixed,QtGui.QSizePolicy.Fixed), 0, 1, 1, 4)        
        self.label1 = QtGui.QLabel()
        self.label1.setText(QtGui.QApplication.translate("SteamTables", "Color del resaltado:", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label1, 1, 1, 1, 1)
        self.ColorButton = QtGui.QToolButton()
        self.ColorButton.clicked.connect(self.ColorButtonClicked)
        ...
        self.label4=QtGui.QLabel()
        self.label4.setText(QtGui.QApplication.translate("SteamTables", "Tamaño gráficos", None, QtGui.QApplication.UnicodeUTF8))
        self.Layout.addWidget(self.label4,3,1,1,1)
        self.tamano=QtGui.QSlider(QtCore.Qt.Horizontal)
        self.tamano.setRange(10, 200)
        self.tamano.valueChanged.connect(self.PosicionChanged)
        self.Layout.addWidget(self.tamano,3,3,1,1)
        self.label5=QtGui.QLabel()
        self.label5.setText(str(self.tamano.value()))
        self.label5.setAlignment(QtCore.Qt.AlignRight)
        self.Layout.addWidget(self.label5,3,2,1,1)
