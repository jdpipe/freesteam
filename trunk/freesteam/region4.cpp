...
Region4::pitau_iaps85(const SteamCalculator &c) const{
	throw std::runtime_error("Invalid call to Region4::pitau_iaps85: not implemented");
	return 0;
}

Num
Region4::delpi_iaps85(const SteamCalculator &c) const{
	throw std::runtime_error("Invalid call to Region4::delpi_iaps85: not implemented");
}
